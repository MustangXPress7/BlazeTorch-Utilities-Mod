...
public class ItemPortalFinder extends Item{

	public ItemPortalFinder(int par1, ToolMaterial par2EnumToolMaterial) {
		super();
...
if (thisOne!=null)
{
	...
	*/
	par2World.spawnParticle("witchMagic", (double)par3EntityPlayer.posX, (double)par3EntityPlayer.posY, (double)par3EntityPlayer.posZ, thisOne.posX - par3EntityPlayer.posX, thisOne.posY - par3EntityPlayer.posY, thisOne.posZ - par3EntityPlayer.posZ);
}
